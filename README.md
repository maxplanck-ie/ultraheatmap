...
<p align="center">
  ...
  <em>This figure is generated by the ultraheatmap on a real data. The first two columns show the ChIPs signal while the last column shows the gene expression of the closest gene to each region of any cluster.</em>
</p>
