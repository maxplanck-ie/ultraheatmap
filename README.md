...
<p align="center">
  <img width="460" height="300" src="./docs/content/images/ultraheatmap_ferrari.png">
</p>

![addFeatureToMatrix example](./docs/content/images/ultraheatmap_ferrari.png)
*This figure is generated by the ultraheatmap on a real data. The first two columns show the ChIPs signal while the last column shows the gene expression of the closest gene to each region of any cluster.*
